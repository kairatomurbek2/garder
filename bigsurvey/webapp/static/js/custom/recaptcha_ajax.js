(function () {
    ...
    ;
    var cb = -1 != B.indexOf("Opera") || -1 != B.indexOf("OPR"), C = -1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE"), E = -1 != B.indexOf("Gecko") && -1 == B.toLowerCase().indexOf("webkit") && !(-1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE")), F = -1 != B.toLowerCase().indexOf("webkit"), db = function () {
        var a = k.document;
        ...
        if (!(b = fb[a])) {
            ...
            for (var c = va(String(eb)).split("."), d = va(String(a)).split("."), e = Math.max(c.length, d.length), g = 0; 0 == b && g < e; g++) {
                var f = c[g] || "", m = d[g] || "", D = RegExp("(\\d*)(\\D*)", "g"), M = RegExp("(\\d*)(\\D*)", "g");
                do {
    ...
    var kc = function (a) {
        var b = {}, c = b.document || document, d = document.createElement("SCRIPT"), e = {
            script_: d,
            timeout_: void 0
        }, g = new N(gc, e), f = null, m = null != b.timeout ? b.timeout : 5E3;
    ...
    var Z = {
        ...
        _init_builtin_theme: function () {
            var a = Z.$, b = Z._get_static_url_root(), c = w.VertCss, d = w.VertHtml, e = b + "/img/" + Z.theme, g = "gif", b = Z.theme;
