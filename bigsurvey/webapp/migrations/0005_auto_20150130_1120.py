...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('webapp', '0004_auto_20150130_1105'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='employee',
            name='company',
            field=models.CharField(max_length=30, null=True, verbose_name='Company', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='employee',
            name='phone1',
            field=models.CharField(max_length=20, null=True, verbose_name='Phone 1', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='employee',
