    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('browse_site', 'Can browse Site'), ('access_to_all_sites', 'Has access to all Sites'), ('access_to_pws_sites', "Has access to PWS's Sites"), ('access_to_survey_sites', 'Has access to Sites that he inspects'), ('access_to_import', 'Can import Sites from Excel file'), ('assign_surveyor', 'Can assign Surveyor to Site'), ('commit_site', 'Can commit Site'), ('access_to_batch_update', 'Has access to batch update')),
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(max_length=255, null=True, verbose_name='Notes', blank=True)),
                ('hazards', models.ManyToManyField(related_name='surveys', null=True, verbose_name='Hazards', to='webapp.Hazard', blank=True)),
