...
class Site(models.Model):
    ...
    apt = models.CharField(max_length=50, blank=True, null=True, verbose_name=_("Apt"), help_text=_("Site Address's Apartment"))
    ...
    cust_apt = models.CharField(max_length=50, blank=True, null=True, verbose_name=_("Customer Apt"), help_text=_("Customer's Apartment"))
