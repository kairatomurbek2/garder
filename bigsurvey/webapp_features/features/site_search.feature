...
Feature: Site search
  ...
  Scenario Outline: Search by fields
    ...
    When I select "NUI812, North USA PWS" from "pws"
    ...
    Examples:
      ...
      | bp_device_serial_no | 321         | 7269 South Jackson st, Seattle 18921 Customer number: VALVE                   |
  ...
  Scenario: Search by address returns all sites with addresses containing the search term
    ...
    | site_link                                                                     |
    | 7269 South Jackson st, Seattle 18921 Customer number: VALVE                   |
  ...
  @keep_db
  Scenario Outline: Customer number, Meter number, BP Device Serial No fields require exact match
    Given I logged in as "tester"
    And I select "NUI812, North USA PWS" from "pws"
    ...
    Examples:
      ...
      | bp_device_serial_no | 321              | 3                   | 7269 South Jackson st, Seattle 18921 Customer number: VALVE                   |