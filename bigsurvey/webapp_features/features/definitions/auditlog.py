...
@step(u'owner filters auditlog from current month start to current month end$')
...
@step(u'owner filters auditlog from next month start to next month end$')
def when_owner_filters_from_current_month_start_to_current_month_end(step):
