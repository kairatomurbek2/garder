...
class Messages:
    ...
    class UserInvite:
        user_not_found = _('User with such personal data not found')
        user_already_in_pws = _('Selected user is employee of selected PWS already')
        user_invite_error = _('Error while submitting form')
        user_invite_success = _('Invite have been sent to selected user\'s email. He should accept it in 3 days')
        user_invite_failed = _('Failed to send invite. Please, try again later.')
...
POSSIBLE_IMPORT_MAPPINGS = {
    ...
    "Service Site Apt": ('siteapt', 'servicesiteapt', 'serviceapt', 'apt', 'apartment',),
    ...
    "Customer Name 2": ('custaddress1', 'customeraddress1', 'custaddress', 'customeraddress', 'customername2'),
    ...
    "Mailing ZIP": ('custzip', 'customerzip', 'mailingzip'),
